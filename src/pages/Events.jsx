...
const Events = () => {
  ...
  return (
    <div className='min-h-screen p-8 bg-gray-200'>
      ...
      <p className='w-[60%] mx-auto p-7 text-center'>School activities play a crucial role in shaping students academic, social, and personal development. These activities go beyond the standard classroom curriculum and provide students with practical learning experiences.</p>
